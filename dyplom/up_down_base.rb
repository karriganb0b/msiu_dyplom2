...
\\end{verbatim}
	...
	file = File.open("words/test_migration/test_true/up_down_base.tex", 'a'){ |file| file.puts vopros}
  file = File.open("words/test_migration/test_true/up_down_base.tex", 'a'){ |file| file.puts res.shuffle.join("\n")}
end
