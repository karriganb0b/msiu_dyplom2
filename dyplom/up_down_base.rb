...
\\end{verbatim}
	...
	file = File.open("words/test_migration/test_true/rubezh.tex.rb", 'a'){ |file| file.puts vopros}
  file = File.open("words/test_migration/test_true/rubezh.tex.rb", 'a'){ |file| file.puts res.shuffle.join("\n")}
end
